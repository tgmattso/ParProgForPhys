...
History: Written by Tim Mattson, March 2024.
         Updated by Tim Mattson for TLB tiling, June 2026
...
void init_par_arrs(int N, double *A, double *B)
{
...
void transomp_tile_test(int N, double *A, double *B)
{
   double start_time, time;
...
// Test transpose results
   ...
   printf(" OMP-tiled trans in %f seconds with %ld errors\n",time,err);
}
